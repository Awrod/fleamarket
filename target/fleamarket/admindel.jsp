    ...
    <div class="layui-body">
        <table class="layui-table">
            ...
            <tr>
                ...
                <td><a style="margin-left: 2%" href="${pageContext.request.contextPath}/UserServlet.do?hidden=admindel&userid=<%out.print(user.getUserId());%>"><input type="button" onclick="return button_click()" class="layui-btn" value="删除"></a>
                </td>
            </tr>
            <% } %>
            </tbody>
        ...
        %>
        <a style="margin-left: 2%" href="${pageContext.request.contextPath}/UserServlet.do?hidden=auserdel&ppage=<%out.print((i-1)*5);%>"><input type="button" class="layui-btn" value="<%out.print(i);%>"></a>
        <%}%>
    </div>
</div>
</body>
