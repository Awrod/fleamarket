...
<%--  商品分类  --%>
    <div style="height: 70%;">
        ...
        <div style="float: left" class="layui-carousel" id="test1">
            <div carousel-item>
                <div><img style="height: 100%;width: 100%" src="/image/image1.jpg"></div>
                <div><img style="height: 100%;width: 100%" src="/image/image2.jpg"></div>
                <div><img  style="height: 100%;width: 100%" src="/image/image3.jpg"></div>
            </div>
        </div>
    </div>
    <div style="height: 10%;background-color: white"></div>
    <div style="background: white;text-align: center;">
        <img  src="${pageContext.request.contextPath}/image/lowimage.jpg">
    </div>
    </body>
<%-- 登入/注册 --%>
