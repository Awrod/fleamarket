...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <%--添加商品--%>
            ...
            <form id="addform" class="layui-form child" onsubmit="return submit()" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/GoodsServlet.do">
                <input type="hidden" name="hidden" value="selleradd">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="file" style="margin-left: 3%" lay-verify="required"  id="uploadImage" onchange="loadImageFile()" name="goodsPhoto">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="margin-right: 3%">商品详情图一:</label>
                    <div class="layui-input-block">
                        <img id="uploadPreviewoo"  style="width: 150px;height: 150px" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <img id="uploadPreviewtt"  style="width: 150px;height: 150px" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <img id="uploadPreviewss"  style="width: 150px;height: 150px" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" style="width: 300px"  lay-verify="required"   id="goodsName"  name="goodsName"   class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" style="width: 300px;float: left"  lay-verify="required" onchange="chkgoodsQuantity(this.value);"   id="goodsQuantity"  name="goodsQuantity"   class="layui-input">
                    ...
                    <div class="layui-input-block">
                        <input type="text" style="width: 300px;float: left"  lay-verify="required" onchange="chkPrice(this.value);"   id="goodsPrice"  name="goodsPrice"   class="layui-input">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="goodsSynopsis" maxlength="150" lay-verify="required" id="goodsSynopsis"   placeholder="请输入内容" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item" style="margin-left: 15%">
                    <div class="layui-input-block">
                        <button class="layui-btn"  lay-submit lay-filter="formDemo">上架商品</button>
                    </div>
                </div>
            </form>
        </div>
