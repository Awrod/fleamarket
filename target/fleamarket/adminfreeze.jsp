    ...
    <div class="layui-body">
        <table class="layui-table">
            ...
            <tr>
                ...
                <td><a style="margin-left: 2%" href="${pageContext.request.contextPath}/UserServlet.do?hidden=freezeuser&userid=<%out.print(user.getUserId());%>"><input type="button" onclick="return button_click()" class="layui-btn" value="冻结"></a>
                <td><a style="margin-left: 2%" href="${pageContext.request.contextPath}/UserServlet.do?hidden=unfreeze&userid=<%out.print(user.getUserId());%>"><input type="button" onclick="return button_clickt()" class="layui-btn" value="解冻"></a>
                </td>
            </tr>
            <% } %>
            </tbody>
        ...
        %>
        <a style="margin-left: 2%" href="${pageContext.request.contextPath}/UserServlet.do?hidden=freeze&ppage=<%out.print((i-1)*5);%>"><input type="button" class="layui-btn" value="<%out.print(i);%>"></a>
        <%}%>
    </div>
</div>
</body>
