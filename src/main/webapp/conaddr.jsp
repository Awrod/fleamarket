...
<div style="width: 100%;height: 30px;margin-top: 3px"><a href="${pageContext.request.contextPath}/DaServlet.do?hidden=addaddr"><input type="button" class="layui-btn" value="添加收货地址"></a></div>
<h2 style="margin-top: 3%">${msg}</h2>
...
<table class="layui-table">
    ...
    <tbody>
    <%for (DaTableEntity da:dalist){%>
    <tr>
        <td> <%out.print(da.getDaName());%></td>
        <td><%out.print(da.getUserMoblie());%></td>
        <td><%out.print(da.getUserAddr());%></td>
        <td><a href="${pageContext.request.contextPath}/DaServlet.do?hidden=upaddr&daId=<%out.print(da.getDaId());%>&daName=<%out.print(da.getDaName());%>&userMoblie=<%out.print(da.getUserMoblie());%>&userAddr=<%out.print(da.getUserAddr());%>"><input type="button" class="layui-btn" value="修改收货地址"></a></td>
        <td><a href="${pageContext.request.contextPath}/DaServlet.do?hidden=deladdr&daId=<%out.print(da.getDaId());%>"><input onclick="return sumbit_form()" type="button" class="layui-btn" value="删除收货地址"></a></td>
    </tr>
    <% }%>
    </tbody>
</table>
