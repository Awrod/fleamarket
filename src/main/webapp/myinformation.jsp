...
<%--个人信息--%>
<h2>${mes}</h2>
<form class="layui-form child" action="${pageContext.request.contextPath}/UserServlet.do" method="post">
    <input type="hidden" name="hidden" value="updateinfo">
    <div class="layui-form-item ">
        <label class="layui-form-label">头像:</label>
        <div class="layui-input-block">
            <img style="width: 50px;height: 50px"  src="${photo}" >&nbsp;&nbsp;&nbsp;<a class="layui-btn" href="${pageContext.request.contextPath}/updatephoto.jsp">修改头像</a>
            <input  readonly="readonly"  type="text" style="border: 0px;">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">用户名:</label>
        <div class="layui-input-block">
            <input type="text" style="width: 300px" value="${name}" maxlength="12" readonly="readonly" id="myusername"  name="userName"   class="layui-input">
            <input  readonly="readonly"  type="text" style="border: 0px;">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="password" value="${pass}" style="width: 300px" name="userPass"  class="layui-input">
            <input  readonly="readonly"  type="text" style="border: 0px;">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" style="width: 300px" value="${moblie}" maxlength="11"  id="mymoblie"  name="userMoblie"   class="layui-input">
            <input  readonly="readonly"  type="text" style="border: 0px;">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" style="width: 300px" value="${ren}" maxlength="11"   name="userReallyn"   class="layui-input">
            <input  readonly="readonly"  type="text" style="border: 0px;">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" style="width: 300px" readonly="readonly" onchange="isCardNo(this.value)"  value="${idc}" maxlength="18" id="idcardMoblie"    name="useridcard"   class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="userSex" value="男" title="男"<%if ("男".equals(sex)){%> checked <%}%>>
            <input type="radio" name="userSex" value="女" title="女" <%if ("女".equals(sex)){%> checked <%}%>>
        </div>
        <div class="layui-form-mid layui-word-aux">用户名,身份证不可更改！</div>
    </div>
